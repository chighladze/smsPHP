...
WHERE na.statusID = 0
  ...
  AND -DATEDIFF(na.disDate, CURDATE()) = 6');
    $db->beginTransaction();
    foreach ($query as $row) {
        ...
        if ($tvTariffPrice > 0) {
            $message = "შეგახსენებთ, ინტერნეტ+ტვ სერვისი ($payID) გათიშულია გადაუხდელობის გამო. მომსახურების გასააქტიურებლად მინიმალური გადასახადი შეადგენს ($debt) ლარს. სააბონენტო თანხა - ($fullPay) ლარი. გადახდა შეგიძლიათ სწრაფი ჩარიცხვის აპარატის ან ინტერნეტ ბანკის მეშვეობით.";
        } else {
            $message = "შეგახსენებთ, ინტერნეტ სერვისი ($payID) გათიშულია გადაუხდელობის გამო. მომსახურების გასააქტიურებლად მინიმალური გადასახადი შეადგენს ($debt) ლარს. სააბონენტო თანხა - ($fullPay) ლარი. გადახდა შეგიძლიათ სწრაფი ჩარიცხვის აპარატის ან ინტერნეტ ბანკის მეშვეობით.";
        }
