...
WHERE na.statusID = 0
  ...
  AND -DATEDIFF(na.disDate, CURDATE()) = 1');
    $db->beginTransaction();
    foreach ($query as $row) {
        ...
        if ($tvTariffPrice > 0) {
            $message = "გაცნობებთ, ინტერნეტ+ტვ სერვისი ($payID) გათიშულია გადაუხდელობის გამო. მომსახურების გასააქტიურებლად მინიმალური გადასახადი შეადგენს ($debt) ლარს. სააბონენტო თანხა($fullPay) ლარი. გადახდა შეგიძლიათ სწრაფი ჩარიცხვის აპარატის ან ინტერნეტ ბანკის მეშვეობით.";
        } else {
            $message = "გაცნობებთ, ინტერნეტ სერვისი ($payID) გათიშულია გადაუხდელობის გამო. მომსახურების გასააქტიურებლად მინიმალური გადასახადი შეადგენს ($debt) ლარს. სააბონენტო თანხა ($fullPay) ლარი. გადახდა შეგიძლიათ სწრაფი ჩარიცხვის აპარატის ან ინტერნეტ ბანკის მეშვეობით.";
        }
