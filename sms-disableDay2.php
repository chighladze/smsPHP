...
WHERE na.statusID = 0
  ...
  AND -DATEDIFF(na.disDate, CURDATE()) = 2');
    $db->beginTransaction();
    foreach ($query as $row) {
        ...
        $message = "შეგახსენებთ, ანგარშზე ($payID) გადაუხდელობის გამო შეგეზღუდათ სერვისების მოწოდება. მინიმალური გადასახადი შეადგენს ($debt) ლარს, სააბონენტო თანხა ($fullPay) ლარი. ან მომსახურების დროებით გასააქტირებლად შეგიძლიათ ისარგებლოთ კრედიტით. აქტივაციისთვის მიმართეთ ცხელ ხაზს 0322500300  ან ესტუმრეთ ვებ გვერდს www.skytel.ge";
