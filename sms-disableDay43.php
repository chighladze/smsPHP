...
WHERE na.statusID = 0
  ...
  AND -DATEDIFF(na.disDate, CURDATE()) = 43');
    $db->beginTransaction();
    foreach ($query as $row) {
        ...
        if ($tvTariffPrice > 0) {
            $message = "შეგახსენებთ, რომ ინტერნეტ+ტვ სერვისი ($payID) გათიშულია გადაუხდელობის გამო. იგეგმება მომსახურების გაუქმება და აპარატურის დემონტაჟი ხელშეკრულებით გათვალისწინებულ ვადაში. მომსახურების გასააქტიურებლად, გთხოვთ გადაიხადოთ სააბონენტო თანხა ($fullPay) ლარი სწრაფი ჩარიცხვის აპარატის ან ინტერნეტ ბანკინგის მეშვეობით.";
        } else {
            $message = "შეგახსენებთ, რომ ინტერნეტ სერვისი ($payID) გათიშულია გადაუხდელობის გამო. იგეგმება მომსახურების გაუქმება და აპარატურის დემონტაჟი ხელშეკრულებით გათვალისწინებულ ვადაში. მომსახურების გასააქტიურებლად, გთხოვთ გადაიხადოთ სააბონენტო თანხა ($fullPay) ლარი სწრაფი ჩარიცხვის აპარატის ან ინტერნეტ ბანკინგის მეშვეობით.";
        }
